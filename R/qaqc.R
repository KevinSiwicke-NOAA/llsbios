...
qaqc <- function(channel, station) {
  ...
  make_plots(sta = station, depth = qaqc_plot_dat[[1]], chx = qaqc_plot_dat[[2]], lengths = qaqc_plot_dat[[3]], lenE = qaqc_plot_dat[[4]], lenO = qaqc_plot_dat[[5]], StnLoc = qaqc_plot_dat[[6]], stnd = dat[[4]])
}
